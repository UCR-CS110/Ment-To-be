          ...
          <Box my={2}>
            <Stack>
              ...
              <Text
                ...
                textTransform={"uppercase"}
              >
                {mentor.mentor_profile.mentor_email}
              </Text>
            </Stack>
          </Box>
          ...
          <Box my={2}>
            <Stack>
              ...
              <Text
                ...
                textTransform={"uppercase"}
              >
                {mentor.mentor_profile.mentor_university}
                {" - "}
                {mentor.mentor_profile.mentor_degree !== "none" &&
                  mentor.mentor_profile.mentor_degree}
              </Text>
            </Stack>
          </Box>
          ...
          <Box my={2}>
            <Stack>
              ...
              <Text
                ...
                textTransform={"uppercase"}
              >
                {mentor.mentor_profile.mentor_language}
              </Text>
            </Stack>
          </Box>
          ...
          <Box my={2}>
            <Stack>
              ...
              <Text
                ...
                textTransform={"uppercase"}
              >
                {mentor.mentor_profile.mentor_topic}
              </Text>
            </Stack>
          </Box>
        </Flex>
