		...
		>
			<Flex direction={"column"} mt={0}>
				<Box>
					...
					>
						roles of mentee/mentors
					</Heading>
				</Box>
				<Text align={"left"} fontSize="xl" color={text_colors}>
					{
						"Check out BetterUp to learn all about mentees, mentors, and ways to maximize your role!"
					}
				</Text>
				<Stack mt={8} mb={2}>
					<Image
						backgroundColor="transparent"
						src={"/media/dashboard/resourcess/resource-roles.svg"}
						width={"auto"}
						height={"auto"}
					></Image>
				</Stack>
				...
				<Box align={"center"}>
					<Link rounded={"md"} href={"https://www.betterup.com/blog/mentor-mentee-relationship"}>
						<Button
							variant="outline"
							alignItems="center"
                            w={{ base: "full", sm: "auto" }}
...
export default RolesResourceCard;
